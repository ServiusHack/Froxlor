	...
	'groups' => array(
		'mail' => array(
			...
			'fields' => array(
				...
				'system_mail_autoconfig_enabled' => array(
					'label' => $lng['serversettings']['mail_autoconfig_enabled'],
					'settinggroup' => 'system',
					'varname' => 'mail_autoconfig_enabled',
					'type' => 'bool',
					'default' => false,
					'save_method' => 'storeSettingMailAutoconfig',
					),
				'system_mail_domain' => array(
					'label' => $lng['serversettings']['mail_domain'],
					'settinggroup' => 'system',
					'varname' => 'mail_domain',
					'type' => 'string',
					'default' => '',
